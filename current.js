...
function forecastWeather(){
  fetch("https://api.openweathermap.org/data/2.5/onecall?lat=53.649&lon=-1.7842&exclude=current,minutely,hourly&appid=a5f760dacb2564a55f8c91770b75eebe&units=metric")
  .then(res => res.json())
  .then(data => {
